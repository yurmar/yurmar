import{j as e,m as x,A as b}from"./vendor-motion-BtEwk5Qp.js";import{u as j,a as c}from"./vendor-redux-Bf_jGU28.js";import{a as v,b as y}from"./app-NVDCH9iS.js";import{b as _}from"./vendor-router-B-Z7ZT8I.js";import{F as w,l as k,v as N,q as $,w as z,X as S,o as C}from"./vendor-ui-DFhF8sOR.js";import"./vendor-http-C0Zqfgkc.js";function u(s){return new Date(s).toLocaleString("ru-RU",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}function O(s){const a=(t,l)=>l?`<p><b>${t}:</b> ${String(l).replace(/\n/g,"<br>")}</p>`:"";return`<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8">
